...
class User extends Conn
{
    ...
    public function agendamento(){
        ...
        $this->conn = $this->connect();
        //Query sql
        $query = "INSERT INTO agendamento(nome, telefone, endereco, nomeTecnico, data, escolha, pagamento, descricao) VALUES (:nome, :telefone, :endereco, :nomeTecnico, :data, :escolha, :pagamento, :descricao)";
        ...
        $addUser->bindParam(':data',$this->formData['data']);
