...
<div class="input-group flex-nowrap">
  ...
  <input name="data" type="date" class="form-control" placeholder="Rua palmodel - 69" aria-label="Username" id="txtfieldendereco" aria-describedby="addon-wrapping">
</div>
<label for=""><b>Escolha qual serviço você precisa</b></label><br>
<input type="radio" name="escolha" value="VT"> Visita tecnica  - R$149,99<br>
<input type="radio" name="escolha" value="OS"> Ordem de serviço - R$250,00
<br>
...
<a href="telaView.php"><input type="button" value="CANCELAR" id="btn" class="btn btn-primary mb-3"></a>
